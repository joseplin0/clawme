...
- 更完整的项目现状、代码地图和路线图已收敛到 [`docs/content/README.md`](./docs/content/README.md)。
...
- `docs/`: 文档站工程与配置
- `docs/content/`: 当前实现文档、愿景设计和长期规划

## 文档

- 文档中心：[`docs/content/README.md`](./docs/content/README.md)
- 项目现状：[`docs/content/PROJECT_STATUS.md`](./docs/content/PROJECT_STATUS.md)
- 代码地图：[`docs/content/CODEBASE_MAP.md`](./docs/content/CODEBASE_MAP.md)
- 当前路线图：[`docs/content/ROADMAP.md`](./docs/content/ROADMAP.md)
